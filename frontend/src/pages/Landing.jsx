        ...
        <div>
            ...
            <section className="hero">
                <div className="hero-left">
                    ...
                    <div className="hero-badges">
                        <span className="badge">✔ Multi-Company Secure</span>
                        <span className="badge">✔ Staff Access Control</span>
                        <span className="badge">✔ Invoice + GST Ready</span>
                    </div>
                </div>
            ...
            <section className="pricing">
                ...
                <div style={{ display: "flex", gap: "20px", justifyContent: "center", flexWrap: "wrap", marginBottom: "30px" }}>
                    <div className="pricing-card" style={{ maxWidth: "350px", textAlign: "left" }}>
                        <h3>Starter</h3>
                    ...
                    <div className="pricing-card" style={{ maxWidth: "350px", textAlign: "left", border: "1px solid var(--primary)" }}>
                        <h3>Pro</h3>
                ...
                <div style={{ marginTop: "10px", textAlign: "center" }}>
                    <Link className="btn" to="/pricing">Compare All Features &rarr;</Link>
                </div>
            </section>
