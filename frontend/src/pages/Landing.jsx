  ...
  return (
    <div>
      ...
      <section className="pricing">
        ...
        <p className="muted">Pay once and start managing your business instantly.</p>
        ...
        <div className="pricing-card">
          ...
          <ul>
            ...
            <li>✔ Secure Company Isolation</li>
          </ul>
          <Link className="btn primary" to="/register">Buy & Register</Link>
        </div>
      </section>
